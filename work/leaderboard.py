...
Description:
  ...
  s3_make_pptx.py, which draws the
...
Output files:
  ...
  resources_raw/leaderboard.json
...
BOARDS = [
    ...
    },
    {
        ...
        "label": "Coding",
        "xlsx": "leaderboard_text_coding.xlsx",
    },
]

JSON_OUT = "resources_raw/leaderboard.json"

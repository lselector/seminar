...
Run s2_clean_images.py afterwards.

Usage:
    python3 s1_fetch_images.py 2026-09-18-AI-News.md
    python3 s1_fetch_images.py deck.md --force
...
from deck_parser import image_manifest, parse_deck_file
...
def resolve_deck(argv):
    ...
    if not named:
        log_message(
            "Usage: python3 s1_fetch_images.py deck.md"
        )
        sys.exit(1)
